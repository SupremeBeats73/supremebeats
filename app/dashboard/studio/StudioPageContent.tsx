  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-0">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-white sm:text-2xl">Studio</h1>
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <Link
            ...
            className="inline-flex min-h-[44px] items-center rounded-xl border border-white/20 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-white/5"
          >
            Project detail
          </Link>
          <Link
